...
export default class TextArea extends React.Component {
    ...
    render() {
        if (!this.state.mounted) {
            ...
            const {name, value, id, onChange, hint, clickable, placeholder, handler, label, height, editValidator, loading} = this.props;
                ...
                return (
                    <div style={{margin: "0px 0px 15px 0px"}}>
                        ...
                        <div style={{marginTop: "20px"}}>
                            <Button value={"Update"} color={colors.green["600"]} onClick={handler} validator={editValidator} loading={loading}/>
